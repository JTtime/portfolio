...
const portfolioData: PortfolioData = {
  ...
  social: [
    { label: "GitHub", url: "https://github.com/jeevraj", icon: "Github" },
    { label: "Twitter / X", url: "https://twitter.com/jeevraj", icon: "Twitter" },
    {
      label: "LinkedIn",
      url: "https://linkedin.com/in/jeevraj",
      icon: "Linkedin",
    },
    { label: "Email", url: "mailto:hello@jeevraj.dev", icon: "Mail" },
  ],
  ...
  projects: [
    {
      ...
      githubUrl: "https://github.com/jeevraj/pdf-table-extractor",
      featured: true,
      year: 2024,
    },
    {
      ...
      githubUrl: "https://github.com/jeevraj/trishasync",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/jeevraj/rag-pipeline",
      year: 2024,
    },
    {
